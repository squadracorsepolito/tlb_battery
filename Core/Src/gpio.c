...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PCPin PCPin PCPin PCPin
                           ...
                           PCPin PCPin */
  GPIO_InitStruct.Pin = FB_IMD_ERR_GPIO_IN_Pin|SD_FB_AMS_ERR_RLY_TO_IMD_ERR_RLY_GPIO_IN_Pin|SD_FB_SD_MID_IN_TO_AMS_ERR_RLY_GPIO_IN_Pin|FB_nANY_IMPL_ERR_GPIO_IN_Pin
  ...
  GPIO_InitStruct.Pin = FB_AMS_ERR_GPIO_IN_Pin|FB_AIR_POS_INT_SD_REL_GPIO_IN_Pin|FB_AIR_NEG_INT_SD_REL_GPIO_IN_Pin|FB_DCBUS_PRCH_RLY_INT_SD_REL_GPIO_IN_Pin
